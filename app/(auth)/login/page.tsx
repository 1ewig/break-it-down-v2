      ...
      <div className="w-full max-w-sm">
        ...
        <div className="p-8 bg-surface border border-text-secondary/5 rounded-3xl shadow-sm">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-background border border-text-secondary/10 rounded-2xl hover:bg-surface transition-colors font-medium flex items-center justify-center gap-3 text-text-primary"
          >
